...
export default function ResetPasswordPage() {
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-[#f8f9fa] flex flex-col items-center justify-center p-4">
      ...
      >
        <Suspense fallback={
          <div className="bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] p-8 md:p-10 flex flex-col items-center border border-gray-50 h-[600px] justify-center">
